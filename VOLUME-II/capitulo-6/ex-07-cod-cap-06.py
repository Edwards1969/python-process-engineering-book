...
6.5 Simulação de Falhas em Sensores Térmicos. - pág.346

6.5.1 Simulação de Offset em Termopar
...
6.5.2 Aumento de Ruído. pág. 347
...
6.5.3 Simulação de Saturação. pág. 348
...
6.5.4 Sinal Congelado (Sensor Travado). pág.348-349
